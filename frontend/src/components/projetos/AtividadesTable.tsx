          ...
          <table className="w-full border-collapse">
            <thead>
              <tr>
                ...
                {/* Ocupa a vaga da antiga coluna Departamento, e herda o breakpoint dela
                    — o departamento continua disponível pelo filtro da barra. */}
                <th className="hidden bg-surface-2 px-2.5 py-2 text-left font-mono text-[10px] font-medium uppercase tracking-wider text-muted md:table-cell">
                  Descrição
                </th>
                ...
                <th className="hidden whitespace-nowrap bg-surface-2 px-2.5 py-2 text-left font-mono text-[10px] font-medium uppercase tracking-wider text-muted sm:table-cell">
                  Fim previsto
                </th>
            ...
            <tbody>
              ...
              {!loading &&
                ...
                <tr key={row.id} className="border-t border-border/60 transition hover:bg-surface-2">
                  <td className="px-2.5 py-1.5 text-sm font-semibold">
                    <button
                  ...
                  <td className="max-w-[220px] px-2.5 py-1.5 text-sm text-foreground">
                    <p className="truncate" title={row.cliente}>
                      {row.cliente}
                    </p>
                  </td>
                  {/* Truncate obrigatório, não cosmético: algumas descrições trazem o
                      escopo inteiro da proposta, com vários parágrafos. */}
                  <td className="hidden max-w-[280px] px-2.5 py-1.5 text-sm text-muted md:table-cell">
                    <p className="truncate" title={row.itemDescricao ?? undefined}>
                      {row.itemDescricao ?? "—"}
                    </p>
                  </td>
                  {/* Consultor, Horas e Fim previsto em nowrap: são valores curtos e de
                      largura previsível, e quebrar linha neles desalinha a altura da linha
                      inteira. Quem cede espaço é a Descrição, que já trunca. */}
                  <td className="hidden whitespace-nowrap px-2.5 py-1.5 text-sm text-muted lg:table-cell">
                  ...
                  {/* Atraso comunicado só pela cor: o "· Atrasado" repetia em texto o que o
                      vermelho já diz, e era ele que forçava a quebra de linha. */}
                  <td className="hidden whitespace-nowrap px-2.5 py-1.5 font-mono text-sm sm:table-cell">
                    <span
