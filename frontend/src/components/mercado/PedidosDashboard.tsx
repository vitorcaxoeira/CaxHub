...
export interface PedidosIndicadoresData {
  ...
  topClientes: { codcli: number; nome: string; quantidade: number }[];
...
// KPIs de Pedido + RAT + Proposta (aba "Dash") — sem campo monetário em nenhum dos três
// models, então tudo aqui é contagem/distribuição, não valor. Mesmo padrão visual de
// WorkloadConsultores.tsx (KpiCard + RankingBarra, sem lib de gráfico).
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <RankingBarra titulo="Top Clientes" itens={clientesItens} formatarValor={formatarContagem} unidade="pedidos" />
      </div>
